...
function reset() {
    ...
    fingers.removeAll();
    invs.removeAll();
    spaceKey.onDown.removeAll();  // Elimina todos los eventos asociados con la barra espaciadora
    spaceKey.onDown.add(flap);  // Añade el evento de nuevo
}
...
function flap() {
    ...
    if (!gameOver) {
        ...
        reset();  // Reinicia el juego si está en game over
    }
}
...
function setGameOver() {
    ...
    spaceKey.onDown.addOnce(reset);  // Cambia el control de reinicio a la barra espaciadora
    hurtSnd.play();
}
